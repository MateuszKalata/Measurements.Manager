...
namespace InvalidMsgSaver
{
    public class Program
    {
		...
		static async Task MainTask(string[] args)
		{
			...
			try
			{
				Log.Information($"Starting InvalidMsgSaver service");
				serviceProvider.GetService<InvalidMeasurementsSaver>().ConsumeMeasurements();
		...
		private static void ConfigureServices(IServiceCollection serviceCollection)
		{
			...
			serviceCollection.AddTransient<InvalidMeasurementsSaver>();
		}
    }
}
